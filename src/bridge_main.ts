...
const API: ShowTrakAPI = {
  ...
  GetRemoteDevices: async () => invoke('Remote:GetDevices'),
  RevokeRemoteDevice: async (DeviceID) => invoke('Remote:RevokeDevice', DeviceID),
  RevokeAllRemoteDevices: async () => invoke('Remote:RevokeAllDevices'),
  IssueRemotePairingCode: async () => invoke('Remote:IssuePairingCode'),
  ClearRemotePairingCode: async () => invoke('Remote:ClearPairingCode'),
