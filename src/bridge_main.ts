...
const API: ShowTrakAPI = {
  ...
  // FreeKiosk Terminals
  GetFreeKioskMetrics: async () => invoke('FreeKiosk:GetMetrics'),
  GetFreeKioskCommands: async () => invoke('FreeKiosk:GetCommands'),
  GetAllFreeKioskTerminals: async () => invoke('GetAllFreeKioskTerminals'),
  GetFreeKioskTerminal: async (UUID) => invoke('GetFreeKioskTerminal', UUID),
  GetFreeKioskHistory: async (UUID, MetricKeys) => invoke('FreeKiosk:GetHistory', UUID, MetricKeys),
  GenerateFreeKioskTerminalDefaults: async () => invoke('GenerateFreeKioskTerminalDefaults'),
  CreateFreeKioskTerminal: async (Payload) => invoke('CreateFreeKioskTerminal', Payload),
  UpdateFreeKioskTerminal: async (UUID, Payload) =>
    invoke('UpdateFreeKioskTerminal', UUID, Payload),
  DeleteFreeKioskTerminal: async (UUID) => invoke('DeleteFreeKioskTerminal', UUID),
  RunFreeKioskTerminalsNow: async (UUIDs) => invoke('FreeKiosk:RunNow', UUIDs),
  SendFreeKioskCommand: async (UUIDs, Command, Params) =>
    invoke('FreeKiosk:Command', UUIDs, Command, Params),
  CaptureFreeKioskScreenshot: async (UUID) => invoke('FreeKiosk:CaptureScreenshot', UUID),
  CaptureFreeKioskCamera: async (UUID, Options) => invoke('FreeKiosk:CaptureCamera', UUID, Options),
  GetFreeKioskCameraList: async (UUID) => invoke('FreeKiosk:GetCameraList', UUID),
  SetFullFreeKioskTerminalList: (Callback) => subscribe('SetFullFreeKioskTerminalList', Callback),
  FreeKioskTerminalUpdated: (Callback) => subscribe('FreeKioskTerminalUpdated', Callback),
  ...
  GetAllWorkflows: async () => invoke('Workflows:GetAll'),
  GetWorkflow: async (WorkflowID) => invoke('Workflows:Get', WorkflowID),
  GetWorkflowsForContext: async (ScopedID) => invoke('Workflows:GetForContext', ScopedID),
  GetWorkflowStepKinds: async () => invoke('Workflows:GetStepKinds'),
  GetWorkflowTriggerTypes: async () => invoke('Workflows:GetTriggerTypes'),
  GetWorkflowHistory: async (WorkflowID) => invoke('Workflows:GetHistory', WorkflowID),
  CreateWorkflow: async (Payload) => invoke('Workflows:Create', Payload),
  UpdateWorkflow: async (WorkflowID, Payload) => invoke('Workflows:Update', WorkflowID, Payload),
  DeleteWorkflow: async (WorkflowID) => invoke('Workflows:Delete', WorkflowID),
  SetWorkflowEnabled: async (WorkflowID, Enabled) =>
    invoke('Workflows:SetEnabled', WorkflowID, Enabled),
  SetWorkflowOrder: async (OrderedWorkflowIDs) => invoke('Workflows:SetOrder', OrderedWorkflowIDs),
  SetWorkflowSlug: async (WorkflowID, Slug) => invoke('Workflows:SetSlug', WorkflowID, Slug),
  RunWorkflow: async (WorkflowID, ScopedID, Mode) =>
    invoke('Workflows:Run', WorkflowID, ScopedID, Mode),
  AbortWorkflowRun: async (RunKey) => invoke('Workflows:Abort', RunKey),
  StepWorkflowRun: async (RunKey) => invoke('Workflows:Step', RunKey),
  ContinueWorkflowRun: async (RunKey) => invoke('Workflows:Continue', RunKey),
  AnswerWorkflowPrompt: async (Answer) => invoke('Workflows:AnswerPrompt', Answer),
  GetMonitoringCheckActions: async (CheckID) => invoke('Monitoring:GetCheckActions', CheckID),
  RunMonitoringCheckAction: async (CheckID, ActionID, Params) =>
    invoke('Monitoring:RunCheckAction', CheckID, ActionID, Params),
  SetFullWorkflowList: (Callback) => subscribe('SetFullWorkflowList', Callback),
  OnWorkflowRunUpdated: (Callback) => subscribe('WorkflowRunUpdated', Callback),
  OnWorkflowPromptRequested: (Callback) => subscribe('WorkflowPromptRequested', Callback),
  ...
  SetTagDisplay: async (TagID, Display) => invoke('Tags:SetDisplay', TagID, Display),
