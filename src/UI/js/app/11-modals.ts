...
import { Config, DummyClients, FormatClientVersionLabel, GroupUUIDCache, MonitoringTargets, PendingAdoption, ScriptList, UpdateManagerClientProgress, UpdateManagerDownloadInProgress, UpdateManagerReleaseOptions, UpdateManagerReleaseStatus, UpdateManagerRunning, UpdateManagerSelectedClients, UpdateManagerSelectedReleaseTag, __LastClients, setUpdateManagerClientProgress, setUpdateManagerDownloadInProgress, setUpdateManagerReleaseOptions, setUpdateManagerReleaseStatus, setUpdateManagerRunning, setUpdateManagerSelectedClients, setUpdateManagerSelectedReleaseTag } from './01-state';
...
import type { ClientView, GroupView, ScriptExecutionView } from '@showtrak/protocol';
