...
const Settings: MonitoringSettingField[] = [
  ...
  { Key: 'Port', Label: 'Port', Type: 'number', Default: 80, Min: 1, Max: 65535, Required: true },
  { Key: 'Path', Label: 'Path', Type: 'string', Default: DEFAULT_PATH },
  {
    ...
    Type: 'string',
    Default: '',
    Note: 'Dotted path into the JSON body, e.g. status.code or result.0.status.averageFPS. Leave blank to report reachability only.',
  },
  {
    Key: 'ExpectedValue',
    ...
    Type: 'string',
    Default: '',
    Note: 'Used with the JSON path. Degraded when the value at that path does not match.',
  },
  {
    Key: 'Timeout',
    Label: 'Timeout (ms)',
